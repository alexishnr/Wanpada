...
* Fix regression in `exp detach`.

## [50.0.4] - 2018-03-24

### Changed

* Fix error "Cannot find module 'path-exists'" in `exp detach`.

## [50.0.3] - 2018-03-23

### Changed

*  Switch from tunnel to LAN in project config, if tunnel fails to start.
